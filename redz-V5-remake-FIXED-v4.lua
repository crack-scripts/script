...
return E("UIPadding",{
PaddingLeft=H or UDim.new(0,12),
PaddingRight=I or UDim.new(0,12),
...
local aB=V[self]
local aC,aD,aE=am(self,aw,ax,UDim2.new(1,-25,0,0))
...
local aA=V[self]
local aB,aC,aD=am(self,aw,ax,UDim2.new(1,-15,0,0))
...
local aD=V[self]
local aE,aF,aG=am(self,aw,ax,UDim2.new(1,-100,0,0))
...
local aG,aH,aI=am(self,aw,ax,UDim2.new(0.65,0,0,0))
